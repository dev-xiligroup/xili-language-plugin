...
class Xili_Language_Admin extends Xili_Language {
	...
	public function localize_admin_js( $case_news, $news_id ) {
		$params = array(
			...
			'this_changelog' => $this->changelog,
		);
		return xl_localize_admin_js( $case_news, $news_id, $params );
	}
	...
	public function create_library_of_alert_messages() {
		xl_create_library_of_alert_messages( $this->admin_messages, $this->wikilink );
	}
	...
	*/
	 ...
	 *
	 * @since 1.7.0
	 * @updated 2.4.1, 2.6.2, 2.8.8, 2.23.01
	 */
